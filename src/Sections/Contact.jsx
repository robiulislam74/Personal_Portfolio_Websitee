  ...
  <div className="w-full flex flex-col lg:flex-row gap-8">
    ...
    <div className="w-full lg:w-5/12 p-6 rounded-lg shadow-[0_10px_20px_rgba(0,0,0,0.7)]">
      ...
      <div className="space-y-4 mt-8">
        <h3 className="text-2xl sm:text-3xl text-gray-300 font-bold">Robiul Islam Sumon</h3>
    ...
    <div className="w-full lg:flex-1">
      <div className="text-white rounded-lg shadow-[0_10px_20px_rgba(0,0,0,0.7)] p-6 sm:p-8 w-full space-y-6 ">
        ...
        <div>
          <button className="bg-primaryColor uppercase btn border-none hover:bg-gray-900 hover:shadow-none hover:translate-y-1 duration-300 py-4 w-full text-primaryRed rounded-lg shadow-[0_10px_20px_rgba(0,0,0,0.6)]">
            Send Message →
          </button>
        </div>
      </div>

    ...
    return (
        <div className='max-w-screen-lg mx-auto'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
                <div className='text-[#00D8FF] group hover:bg-[#1A1D21] ease-in duration-200 py-10 px-12 rounded-xl shadow-[0_3px_10px_rgb(200,200,200,0.1)]'>
                ...
                <div className='text-[#00E462] group hover:bg-[#1A1D21] ease-in duration-200 py-10 px-4 rounded-xl shadow-[0_3px_10px_rgb(200,200,200,0.1)]'>
                ...
                <div className='text-[#00BCFF] group hover:bg-[#1A1D21] ease-in duration-200 p-10 rounded-xl shadow-[0_3px_10px_rgb(200,200,200,0.1)]'>
                    <div className='flex items-center gap-2 transition-transform ease-in duration-200 group-hover:scale-110'>
                        <RiTailwindCssFill className='text-5xl' />
                        <span className='text-2xl'>Tailwind</span>
                    </div>
                </div>
                <div className='text-[#4F9B43] group hover:bg-[#1A1D21] ease-in duration-200 p-10 rounded-xl shadow-[0_3px_10px_rgb(200,200,200,0.1)]'>
                    <div className='flex items-center gap-2 transition-transform ease-in duration-200 group-hover:scale-110'>
                ...
                <div className='flex items-center group hover:bg-[#1A1D21] ease-in duration-200 py-10 px-5 rounded-lg shadow-[0_3px_10px_rgb(200,200,200,0.1)]'>
                ...
                <div className='text-[#FFA000] flex items-center group hover:bg-[#1A1D21] ease-in duration-200 gap-2 py-10 px-8 rounded-lg shadow-[0_3px_10px_rgb(200,200,200,0.1)]'>
                    <div className='flex items-center gap-2 transition-transform ease-in duration-200 group-hover:scale-110'>
                    <img src={firebase} className='h-12 w-12' alt="firebase" />
                    <span className='text-2xl'>Firebase</span>
                    </div>
                </div>
                <div className='text-[#860ff5] flex items-center group hover:bg-[#1A1D21] ease-in duration-200 gap-2 py-10 px-8 rounded-lg shadow-[0_3px_10px_rgb(200,200,200,0.1)]'>
                    <div className='flex items-center gap-2 transition-transform ease-in duration-200 group-hover:scale-110'>
